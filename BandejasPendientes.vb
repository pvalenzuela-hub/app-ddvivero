...
Public Class BandejasPendientes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GestionVivero.BandejasPendientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBandejasPendientes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BandejasPendientes = New BandejasPendientes()
        rpt.Site = Me.Site
        Return rpt
    End Function
